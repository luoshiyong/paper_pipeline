...
test_ct_path = '/home/luosy/lits_metric/40test/volume'   #需要预测的CT图像
seg_result_path = '/home/luosy/lits_metric/40test/seg' #需要预测的CT图像标签，如果要在线提交codelab，需要先得到预测过的70例肝脏标签

pred_path = '/home/luosy/lits_metric/pred_result'
...
def main():
    ...
    args = joblib.load('models/LiTS_Unet_lym/2022-09-03-18-27-42/args.pkl')
    print('Config -----')
    for arg in vars(args):
        print('%s: %s' % (arg, getattr(args, arg)))
    print('------------')
    joblib.dump(args, 'models/LiTS_Unet_lym/2022-09-03-18-27-42/args.pkl')
    ...
    model.load_state_dict(torch.load('models/LiTS_Unet_lym/2022-09-03-18-27-42/epoch186-0.9679-0.7708_model.pth'))
    model.eval()
